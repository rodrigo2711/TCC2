...
#define STAPSK  "CEPIITOP"
#endif

const char* ssid     = "VIVO-0A88";
const char* password = "CEPIITOP";

const char* host = "192.168.15.42";
const uint16_t port = 2000;
int i=0;
int a = 0;
int tamanho = 60; //TAMANHO DA LINHA RAW(68 BLOCOS) 
int frequencia = 38; //FREQUÊNCIA DO SINAL IR(32KHz)
unsigned int liga[60] = {3250,9950,550,1650,500,600,500,600,500,600,500,1650,500,600,450,650,500,600,500,600,500,600,500,600,500,650,500,600,450,600,450,650,450,650,450,1650,500,600,500,650,500,600,500,600,450,1650,500,600,500,600,500,1650,450,1650,500,600,450,650,500}; //COLE A LINHA RAW CORRESPONDENTE DENTRO DAS CHAVES
unsigned int desliga[60] = {3150,9950,450,1650,500,600,500,600,500,600,500,1650,500,600,500,600,500,600,500,1650,450,1650,500,600,500,600,500,600,450,600,500,600,450,650,500,600,450,650,500,600,450,650,500,600,450,1650,500,600,500,1650,500,600,500,650,450,600,450,1650,450};
